...
- **[Skin3d Viewer](https://market.azuriom.com/resources/148)** : Une extension (plugin) pour Azuriom permettant de voir voir skin3D (+ 2k téléchargements)
- **[Calendar](https://market.azuriom.com/resources/179)** : Une extension (plugin) pour Azuriom permettant d'ajouter un calendrier complètement configurable.
- **[CentralCorp](https://github.com/CentralCorp)** : A team who work on Minecraft Launcher, Azuriom plugin and other
